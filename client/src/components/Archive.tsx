      ...
      <main className="archive-main">
        <div className="archive-container">
          ...
          <p className="archive-description">
            KelimeLink, her gün yeni bir Türkçe kelime çifti sunan anlamsal bir kelime bağlantı oyunudur.
            Aşağıda geçmiş günlere ait bulmacaları ve en kısa çözüm yollarını (eğer oyuncularımız bulabilmişse) görebilirsiniz.
            Ana sayfada bugünün bulmacasını oynamayı unutmayın!
          </p>
